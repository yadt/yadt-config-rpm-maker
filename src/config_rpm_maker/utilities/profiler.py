...
from config_rpm_maker.configuration import KEY_THREAD_COUNT, get_property
...
def log_execution_time_summaries(logging_function):
    logging_function('Execution times summary (keep in mind thread_count was set to %s):', get_property(KEY_THREAD_COUNT))
